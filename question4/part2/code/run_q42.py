...
def main():
    ...
    inputs = Inputs()
    dependencies = [BASE_DIR.parent/'code'/'rolling_window.py', BASE_DIR.parent/'code'/'run_experiment.py',
    ...
    (HERE/'source_fingerprints.migrated.json').write_text(json.dumps(fingerprints, ensure_ascii=False, indent=2), encoding='utf-8')
