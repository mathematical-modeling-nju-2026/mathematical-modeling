...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.88\textwidth, trim=0 206.6 0 0, clip]{03_q2_residuals.pdf}
\caption{残差口径的配对比较（图 4.3 上半）。(a) 连线连接同一窗口规则在两种
残差口径下的年度费用点，不是置信区间；(b) 分解计划费与紧急费的节省。}
\label{fig:q2-residuals-ab}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.88\textwidth, trim=0 0 0 193, clip]{03_q2_residuals.pdf}
\caption{最终方案相对原方案的累计费用节省（图 4.3 下半）。(c) 展示全年累计节省，
改善集中在启动阶段，3 月 5 日起逐日费用与原方案一致。}
\label{fig:q2-residuals-c}
\end{figure}
