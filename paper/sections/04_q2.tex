...
\noindent\textbf{该修正与窗口方案的区分。} 需强调，残差口径与窗口规则是\textbf{两个独立维度}：
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{03_q2_residuals.pdf}
...
图 \ref{fig:q2-residuals} 把“残差口径”与“窗口规则”两个维度的作用分开呈现。
在具有两种残差口径的三种窗口规则中，排除 1 月 1--7 日回退预测残差后，
56 天等权方案的回测费用最低。累计收益于启动阶段形成，3 月 5 日至 12 月 31 日
逐日费用与原方案一致。因此该改进应解释为\textbf{残差样本口径调整在启动期的作用}，
不能据此声称全年持续适应能力提高。原曲线图（\texttt{q2\_trend.pdf}）
保留作费用趋势的补充展示：
