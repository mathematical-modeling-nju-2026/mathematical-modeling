...
# Do not import the identically named Q3 data module just to locate plot inputs.
...
def main():
    ...
    axs[0].set(ylabel='购电总费用（万元）',title='4-3：波动电价下的费用比较')
    ...
    fig.suptitle('4-3：波动电价下的购电与储能调度')
